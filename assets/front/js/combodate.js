    ...
    Combodate.prototype = {
        ...
        getTemplate: function() {
            ...
            $.each(this.map, function(k, v) {
                ...
                tpl = tpl.replace('{'+token+'}','<select  class="'+k+' '+customClass +'"'+
                     (inputDisabled ? ' disabled="disabled"' : '')+' id="dateid"></select>');
            });
        ...
        */
        fillCombo: function(k) {
            ...
            if(f == 'fillDay'){
                option = 'Date';
                //alert(jQuery('#dateid').attr('name'));
                //jQuery('#dateid').attr('name','date');
            }
            else if(f == 'fillMonth'){
                option = 'Month'
                //jQuery('#dateid').attr('name','month');
            }else{
                option = 'Year';
                //jQuery('#dateid').attr('name','year');
            }
