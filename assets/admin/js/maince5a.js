...
$(window).on('load', function(){
  $('.main-menu').find('.sub-menu-w').parent().addClass('down_icon');
});
$(function () {
...
$(window).on('load resize', function(){
  $('.toggle_icon').click(function(){
    $(this).parent().parent().prev().addClass('slide_toggle');
    $(this).parent().parent().addClass('slide_overlay');
  });
  $('i.close_slidebar').click(function(){
    $(this).parent().parent().removeClass('slide_toggle');
    $(this).parent().parent().next().removeClass('slide_overlay');
  });
var head_heigh = $('.top-bar').outerHeight();
var foot_heigh = $('.adminfooter_cls').outerHeight();
var content_heigh = $(window).outerHeight();
var head_foot_heigh = head_heigh + foot_heigh;
var tot_heigh = content_heigh - head_foot_heigh;
$('.content-box').css('min-height', tot_heigh);
...
/***************Top rated page sticky start*****************/
   var WindowHeight = jQuery(window).height();
   var load_element = 0;
   var scroll_position = jQuery('.remove_company_table').offset().top;
   var screen_height = jQuery(window).height();
   var activation_offset = 0;
   var scroll_activation_point = scroll_position - (screen_height * activation_offset);
   var max_scroll_height = jQuery('.comapre_table_page').height() - 150;
   jQuery(window).on('scroll', function(e) {
   var y_scroll_pos = window.pageYOffset;
       var element_in_view = y_scroll_pos > scroll_activation_point && y_scroll_pos < max_scroll_height + scroll_activation_point - 150;
       if (element_in_view) {
           jQuery('.sticky_width').addClass("sticky");
       } else {
           jQuery('.sticky_width').removeClass("sticky");
       }
   });
   /***************Top rated page sticky end*****************/
