        ...
        <td style="padding:20px 0 20px 0" align="center" valign="top">
         ...
         <td bgcolor="#ffffff" style="font-size:13px;line-height: 10px;border-left: 1px solid #e0e0e0;border-right: 1px solid #e0e0e0;">
          <p><strong>Dear <?php echo ucfirst($mailed_data['username']); ?>,</strong></p>
        	...
        	<p style="margin: 5px 5px;text-align: justify;line-height: 25px;">Thank You for participate in <?php echo $mailed_data['discussion']; ?> discussion.</p>
          <p style="margin: 5px 5px;text-align: justify;line-height: 25px;">Your <strong style="color:#002664">"<?php echo $mailed_data['discussion']; ?>"</strong> discussion has been completed.</p>
