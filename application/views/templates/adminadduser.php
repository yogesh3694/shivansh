        ...
        <td style="padding:20px 0 20px 0" align="center" valign="top">
         ...
         <td bgcolor="#ffffff" style="font-size:13px;line-height: 10px;border-left: 1px solid #e0e0e0;border-right: 1px solid #e0e0e0;">
          <p><strong>Dear <?php echo ucfirst($mailed_data['username']); ?>,</strong></p>
        	<p style="margin: 5px 5px;text-align: justify;line-height: 25px;">Admin has been Added You to Trader Network.</p>
          ...
          <p style="margin: 5px 5px;text-align: justify;line-height: 25px;">Click <a target="_blank" href="<?php echo base_url('login'); ?>">Here</a> to login Trader Network.</p>
         </td></tr>
