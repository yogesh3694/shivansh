      ...
      <tr>
        <td style="padding:20px 0 20px 0" align="center" valign="top">
          <table style="border:1px solid #E0E0E0;"  cellpadding="10" cellspacing="0" width="650">
            ...
            <tr>
                <td style="text-align: center;border-top:1px solid #E0E0E0;border-bottom:1px solid #E0E0E0;     border-left: 1px solid #e0e0e0; border-right: 1px solid #e0e0e0; background:#F3F3F3;"><span style="font-size: 26px; color:#333333;">Decreased Bid</span></td>
              </tr>
            <tr>
         <td bgcolor="#ffffff" style="font-size:13px;line-height: 10px;border-left: 1px solid #e0e0e0;border-right: 1px solid #e0e0e0;">
          <p><strong>Dear <?php echo ucfirst($mailed_data['username']); ?>,</strong></p>
        	<p style="margin: 5px 5px;text-align: justify;line-height: 25px;">You have bid on <strong style="color:#002664">"<?php echo $mailed_data['discussion']; ?>"</strong> discussion of <?php echo '$'.$mailed_data['bid']; ?>. we request to you please decreased your bid.</p>

          <p style="margin: 5px 5px;text-align: justify;line-height: 25px;">
              <a target="_blank" href="<?php echo base_url(); ?>discussion-details/<?php echo $mailed_data['discussion_id']; ?>">Click here</a> to see discussion details.</p>
         </td></tr>
