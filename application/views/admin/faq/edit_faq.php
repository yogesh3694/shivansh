...
<div class="content-i manage_faq_page edit_faq_page">
    <div class="content-box">
        <div class="element-wrapper">
            <div class="element-box table_container">
                <h6 class="element-header">Edit FAQ</h6>
                ...
                <div class="table-responsive">
                    <form name="editfaq" id="editfaq" class="light_font_form" method="post" action="<?php echo base_url('admin/Faq_Master/edit/'.$faqdata->faq_ID);?>">
                        <input type="hidden" name="id" value="<?php echo $faqdata->faq_ID; ?>">
                        <div class="form-div">
                            <div class="on_bhalf_div">
                                <div class="form_group">
                                    <label>Question</label>
                                    <input type="text" name="question" id="question" class="input_text" value="<?php echo $faqdata->question; ?>">
                                    <?php echo form_error('question');?>
                                </div>
                                <div class="form_group">
                                    <label>Answer</label>
                                    <textarea name="answer" rows="5" class="input_textarea" id="answer"><?php echo $faqdata->answer;?></textarea>
                                    <?php echo form_error('answer');?> 
                                </div>                       
                            </div>
                            <input type="submit" class="input_submit" name="submit" value="Update FAQ">
                        </div>
                    </form>             
                    <table id="faqtbl" class="table manage_faq_table admin_table">
                        <thead> 
                            <tr>
                            <th class="no">No.</th>
                        ...
                        <tbody>
                            <?php
                                if(count($allfaqdata) > 0){
                                    $i = 1;
                                    foreach($allfaqdata as $f){
                            ?>
                                        <tr>
                                            ...
                                            <td class="row-actions action text-center">
                                                ...
                                                <a title="Remove" href="<?php echo base_url().'admin/Faq_Master/delete/'.$f->faq_ID;?>" onclick="return confirm('Are you sure Delete')"><i class="icon icon-18"></i></a>
                                            </td>
                                        </tr>
                            <?php
                                        $i++;
